...
def insert_book_data_into_postgres(ti):
    ...
    VALUES (%s, %s, %s, %s)
    """
    # Insert each book into the Postgres table
...
# Define the task to fetch book data
...
# Define the task to create the books table in Postgres
...
# Define the task to insert book data into Postgres
